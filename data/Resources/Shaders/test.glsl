...
vec3 decode_texcoord_to_array(vec2 texCoord)
{
...
void main()
{
	vec3 facedSampleCoord = decode_texcoord_to_array(fSampleCoord);
	vec4 sampleColor = texture(Texture1, facedSampleCoord);
